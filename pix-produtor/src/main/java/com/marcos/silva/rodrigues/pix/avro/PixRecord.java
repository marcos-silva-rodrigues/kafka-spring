 ...
 */
package com.marcos.silva.rodrigues.pix.avro;
...
public class PixRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8815001742782815890L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PixRecord\",\"namespace\":\"com.marcos.silva.rodrigues.pix\",\"fields\":[{\"name\":\"identicador\",\"type\":\"string\"},{\"name\":\"chaveOrigem\",\"type\":\"string\"},{\"name\":\"chaveDestino\",\"type\":\"string\"},{\"name\":\"valor\",\"type\":\"double\"},{\"name\":\"dataTransferencia\",\"type\":\"string\"},{\"name\":\"status\",\"type\":\"string\"}]}");
  ...
  public static PixRecord fromByteBuffer(
   ...
   private java.lang.CharSequence identicador;
   ...
   * @param identicador The new value for identicador
   ...
   */
  public PixRecord(java.lang.CharSequence identicador, java.lang.CharSequence chaveOrigem, java.lang.CharSequence chaveDestino, java.lang.Double valor, java.lang.CharSequence dataTransferencia, java.lang.CharSequence status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: identicador = (java.lang.CharSequence)value$; break;
  ...
  /**
   * Gets the value of the 'identicador' field.
   * @return The value of the 'identicador' field.
   */
  public java.lang.CharSequence getIdenticador() {
    return identicador;
  }


  /**
   * Sets the value of the 'identicador' field.
   * @param value the value to set.
   */
  public void setIdenticador(java.lang.CharSequence value) {
   ...
   */
  public static PixRecord.Builder newBuilder() {
    return new PixRecord.Builder();
  }
   ...
   * @return A new PixRecord RecordBuilder
   */
  public static PixRecord.Builder newBuilder(PixRecord.Builder other) {
    if (other == null) {
      return new PixRecord.Builder();
    } else {
      return new PixRecord.Builder(other);
    }
  }
   ...
   * @return A new PixRecord RecordBuilder
   */
  public static PixRecord.Builder newBuilder(PixRecord other) {
    if (other == null) {
      return new PixRecord.Builder();
    } else {
      return new PixRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PixRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(PixRecord.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.identicador)) {
        this.identicador = data().deepCopy(fields()[0].schema(), other.identicador);
    ...
    /**
      * Sets the value of the 'identicador' field.
      * @param value The value of 'identicador'.
      * @return This builder.
      */
    public PixRecord.Builder setIdenticador(java.lang.CharSequence value) {
    ...
    /**
      * Checks whether the 'identicador' field has been set.
      * @return True if the 'identicador' field has been set, false otherwise.
      */
    public boolean hasIdenticador() {
      return fieldSetFlags()[0];
    }


    /**
      * Clears the value of the 'identicador' field.
      * @return This builder.
      */
    public PixRecord.Builder clearIdenticador() {
      identicador = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder setChaveOrigem(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder clearChaveOrigem() {
      chaveOrigem = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder setChaveDestino(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder clearChaveDestino() {
      chaveDestino = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder setValor(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder clearValor() {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder setDataTransferencia(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder clearDataTransferencia() {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PixRecord.Builder clearStatus() {
      status = null;
    ...
    public PixRecord build() {
      try {
        ...
        record.identicador = fieldSetFlags()[0] ? this.identicador : (java.lang.CharSequence) defaultValue(fields()[0]);
  ...
  @Override public void customEncode(org.apache.avro.io.Encoder out)
    throws java.io.IOException
  {
    out.writeString(this.identicador);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.identicador = in.readString(this.identicador instanceof Utf8 ? (Utf8)this.identicador : null);
